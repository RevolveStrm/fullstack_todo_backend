...
export class AuthService {
	...
	async signIn(signInDto: SignInDto) {
		...
		const passwordsMatch: boolean = await this.userService.verifyPassword(signInDto.password, foundUser.password);
	...
	async refreshToken(userId: string, refreshToken: string) {
		...
		const refreshTokensMatches: boolean = await this.userService.verifyRefreshToken(refreshToken, foundUser.refreshToken);
