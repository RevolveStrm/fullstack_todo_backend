...
async function main() {
  ...
  await prisma.task.createMany({
    data: [
      ...
      {
        title: 'Develop onboarding process',
        description: 'Develop a process for onboarding new users to the platform.',
        status: TaskStatus.UNDONE,
        priority: 1,
        userId: user1.id,
      },
      {
        ...
        description: 'Design wireframes for the new features to be added to the system.',
        status: TaskStatus.UNDONE,
        priority: 2,
        userId: user1.id,
      },
      {
        ...
        description: 'Conduct user testing sessions for the latest features.',
        status: TaskStatus.UNDONE,
        priority: 3,
        userId: user1.id,
      },
      ...
      },
      {
        ...
        description: 'Create a detailed timeline for the next project phase.',
        status: TaskStatus.UNDONE,
        priority: 1,
        userId: user1.id,
      },
      {
        ...
        description: 'Onboard the new clients and guide them through the setup.',
        status: TaskStatus.UNDONE,
        priority: 3,
        userId: user1.id,
      },
      {
        ...
        description: 'Conduct performance reviews for the team members.',
        status: TaskStatus.UNDONE,
        priority: 2,
        userId: user1.id,
      },
